        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<IdentityUser, IdentityRole>().AddDefaultTokenProviders()
                ...
                /*(options => options.SignIn.RequireConfirmedAccount = true)*/
                                                         //silinecek kimlik doðrulamayý biz denetleyeceðiz
            ...
            services.AddAuthentication()
                   ...
                   // })
            // .AddFacebook(options =>                                              
            //paket y.k. komutlarý çalýþtýrdýktan sonra tanýmlanýr
            // {
            ...
            services.ConfigureApplicationCookie(options =>  //KULLANICI LOGIN ÝLE GÝRÝLECEK SAYFALARA ERÝÞMEYE ÇALIÞTIÐINDA
                                                            //KULANICIYI LOGÝN SAYFASINA YÖNLENDÝRÝR!!
            {
